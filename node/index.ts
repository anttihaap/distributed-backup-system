...
const fm = new FileManager(nodeManager, logWriter);
const cn = new ContractNegotiator(nodeManager, udpClient, nodeId, fm, logWriter);
const cm = new ContractManager(nodeManager, udpClient, nodeId, fm, logWriter);

const ts = new TcpServer(localClientConfig.port - 1, host, fm, logWriter);
